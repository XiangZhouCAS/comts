...
option_list <- list(
  ...
  make_option(c("--run_seqkit","-k"),type = "character",default = "run",
	      help = "If you have already counted the number of all reads with seqkit, you can set the directory of seqkit (e.g.'sample_name.singleM.hits.txt') result to skip run seqkit, default is run seqkit"),
