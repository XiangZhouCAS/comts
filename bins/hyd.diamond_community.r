...
option_list <- list(
  ...
  make_option(c("--singleM","-s"),type = "character",default = F,
              help = "please set the directory of singleM's universal single copy ribiosomal genes database, but if you have already counted the RPKM of these genes, you can set the directory of result to skip it"),
